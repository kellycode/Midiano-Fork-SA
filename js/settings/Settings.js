...
export const getSetting = (settingId) => {
    ...
    return globalSettings.settingsById[settingId] ? globalSettings.settingsById[settingId].value : null;
};
...
export const resetSettingsToDefault = () => {
    ...
    let parent = globalSettings.settingsUi.getSettingsDiv(globalSettings.settings).parentElement;
    parent.removeChild(globalSettings.settingsUi.getSettingsDiv(globalSettings.settings));
