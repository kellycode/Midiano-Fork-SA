    ...
    General: {
        ...
        default: [
            ...
            },
            {
                ...
                onChange: (ev) => {
                    ...
                    setSetting("pianoPosition", Math.abs(parseInt(getSetting("pianoPosition")) + 1));
                },
            },
        ...
        "On Screen Piano": [
            ...
            },
            {
                ...
                value: true,
                onChange: (ev) => setSetting("showKeyNamesOnPianoWhite", ev.target.checked),
            },
            {
                type: "checkbox",
                ...
                value: true,
                onChange: (ev) => setSetting("showKeyNamesOnPianoBlack", ev.target.checked),
            },
            {
                type: "checkbox",
